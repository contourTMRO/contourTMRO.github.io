            ...
            <div>
                {buttonAnswer ? (
                    <div class="correct-answer">
                        ...
                        <p>
                        Cervical cancer is stage II if it invades beyond the uterus but does not involve lower 1/3 of vagina or pelvic sidewall.
                        </p>
                        <p>
                        Tumors with invasion of upper 2/3 of vagina are classified as stage IIA (IIA1 if they are ≤4 cm and IIA2 if they are &gt;4 cm). Tumors with parametrial invasion are classified as stage IIB.
                        </p>
                        <p>
                        Invasion into the lower 1/3 of vagina, pelvic sidewall, ureters, or lymph nodes is seen in stage III cervical cancers.
                        </p>
                    </div>
                    ...
                    <div class="answers-container">
                        ...
                        <div class="answer">
                            <label onClick={() => {makeRed('button2');}}>
                                ...
                                <p style={{color: button2Color}}>C. Invasion into upper 2/3 of vagina</p>
                            </label>
                        </div>
                        <div class="answer">
                            <label onClick={() => {makeRed('button3');}}>
                                <button type="radio" onClick={() => {makeRed('button3');}}></button>
                                <p style={{color: button3Color}}>D. Invasion into lower 1/3 of vagina</p>
                            </label>
                        </div>
