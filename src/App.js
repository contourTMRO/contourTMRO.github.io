...
const student_slides = [
  ...
  ["Risks vs. Benefits", Studentslide15],
  ["Your Turn", Studentslide16],
  ["Overview of the radiation process", Studentslide17],
  ["Simulation scan", Studentslide18],
  ["Simulation", Studentslide19],
  // ['Placeholder', Studentslide20],
  ["Simulation", Studentslide21],
  ["Simulation", Studentslide22],
  ["Simulation", Studentslide23],
  ["Simulation", Studentslide24],
  ["Simulation", Studentslide25],
  ["Radiation Planning", Studentslide26],
  ["Radiation Planning", Studentslide27],
  ["Contour Intro", Contourintro],
  ["Contour", Contourslide],
  ["Radiation Planning", Studentslide30],
  ["Radiation Planning", Studentslide31],
  ["Question", Studentslide32],
  ["Radiation Planning", Studentslide33],
  ["Plan Review", Studentslide34],
  ["Plan Review", Studentslide35],
  ["Plan Review", Studentslide36],
  ["Plan Review", Studentslide37],
  ["Plan Review", Studentslide38],
  ["Plan Review", Studentslide39],
  ["Plan Review", Studentslide40],
  ["Treatment", Studentslide41],
  ["Follow-Up", Studentslide42],
];
...
set.add(JSON.stringify(["student_slides", 31]));
  ...
  if (currentSlide === 0)
    return (
      <div className="slideshow-container">
        ...
        <div className="intro-button-group">
          <button onClick={handleResident} className="resident">
            Resident
          </button>
          <button onClick={handleStudent} className="student">
            Medical Student
          </button>
        </div>
      </div>
    ...
    return (
      <div className="slideshow-container">
        ...
        <div className="content-box">
          {currentSlide === 28 && slidesName === "student_slides" ? (
        ...
        <div className="button-group">
          <button onClick={handlePrev} disabled={hidePrev} className="prev">
            Back
          </button>
          {currentSlide === student_slides.length - 1 && slidesName === "student_slides"  || currentSlide === resident_slides.length - 1 && slidesName === "resident_slides" ?
          (
            <button onClick={returnToStart} className="next">
              Return to Start
            </button>
          ) : (
          <p>
