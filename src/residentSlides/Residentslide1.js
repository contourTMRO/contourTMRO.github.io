...
function Residentslide1() {
    return (
        <div class="body">
            ...
            {/* //add a break */}
            <br></br>
            <p>We will review 2 gynecologic cancer cases treated with high-dose rate (HDR) brachytherapy.</p>
            <br></br>
            ...
            <div class="ol-container">
                <ol>
                    ...
                    <li>Dosimetric parameters for evaluation of an HDR radiation treatment plan</li>
                </ol>
            </div>
