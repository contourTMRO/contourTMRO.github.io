        ...
        {buttonAnswer ? (
          <div class="correct-answer">
            ...
            <p>
              ...
              Pittsburgh Medical Center showing excellent local control and
              overall survival outcomes when treating patients with inoperable
              endometrial cancer to a median CTV D90 EQD2 of 48.6 Gy (Gill et
              al., 2014). 65 Gy is the recommended CTV D90 EQD2 for patients
              treated with combination of external beam radiation therapy and
              brachytherapy boost. 80 Gy is the minimum recommended EQD2 for the
              GTV as delineated on T2-weighted MRI (Schwartz et al., 2015).
            </p>
          </div>
        ) : (
